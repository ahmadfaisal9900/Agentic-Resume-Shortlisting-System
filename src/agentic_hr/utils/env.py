...
META_JSON_DIR = Path(
    os.getenv(
        "META_JSON_DIR",
        "/home/ahmad-faisal/lang/HR/Agentic_HR/agentic_hr/docs/Resumes/metadata",
    )
)
RESUME_CSV = Path(
    os.getenv(
        "RESUME_TEXTS_CSV",
        "/home/ahmad-faisal/lang/HR/Agentic_HR/agentic_hr/docs/Resumes/archive/Resume/random_50_rows.csv",
    )
)
